...
sudo consul agent -ui=false -bind=192.168.100.2 -client=0.0.0.0 -data-dir=. -node=cliente_1 -retry-join="192.168.100.3" -retry-join="192.168.100.2" -retry-join="192.168.100.4" &
