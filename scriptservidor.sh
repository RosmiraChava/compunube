...
sudo consul agent -ui -server -bind=192.168.100.3 -client=0.0.0.0 -data-dir=. -node=server -bootstrap-expect=1 -retry-join="192.168.100.3" -retry-join="192.168.100.2" -retry-join="192.168.100.4" &
